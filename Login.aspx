...
<form id="Form1" runat="server">
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    ...
    <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0" id="login-box">
      <h2>Sign Up</h2>
      <div class="relative mb-4">
        <label for="full-name" class="leading-7 text-sm text-gray-600">E-mail</label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
              ErrorMessage="E-mail is a required field" ControlToValidate="TextBox1" 
      ...
      <div class="relative mb-4">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
              ErrorMessage="Password is a required field" ControlToValidate="TextBox2" 
              ForeColor="Red"></asp:RequiredFieldValidator>
      </div>
      ...
      <p class="text-xs text-gray-500 mt-3">This makes your life easier.</p>
    </div>
  </div>
  </form>
</section>
