  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="Registration Page.aspx">Student Registration Form</a>
        </li>
      </ul>
    </div>
  </div>
...
<h2>Registration Form</h2>
  ...
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Full Name</label>
      ...
      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
          ErrorMessage="Name is a required Field" ControlToValidate="TextBox1" 
  ...
  <div class="col-md-6">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ErrorMessage="Contact is a required field" ControlToValidate="TextBox2" 
  ...
  <div class="col-12">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
        ErrorMessage="Address is a required field." ControlToValidate="TextBox3" 
        ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
  ...
  <div class="col-12">
    ...
    <asp:DropDownList ID="DropDownList2" runat="server" class="form-select">
          ...
          <asp:ListItem>Junior Class</asp:ListItem>
          <asp:ListItem>Senior Class</asp:ListItem>
          <asp:ListItem>First Standard</asp:ListItem>
          <asp:ListItem>Second Standard</asp:ListItem>
          <asp:ListItem>Third Standard</asp:ListItem>
          <asp:ListItem>Fourth Standard</asp:ListItem>
          <asp:ListItem>Five Standard</asp:ListItem>
          <asp:ListItem>Sixth Standard</asp:ListItem>
          <asp:ListItem>Seventh Standard</asp:ListItem>
          <asp:ListItem>Eighth Standard</asp:ListItem>
          <asp:ListItem>Nineth Standard</asp:ListItem>
          <asp:ListItem>Tenth Standard</asp:ListItem>
          <asp:ListItem>Eleventh Standard</asp:ListItem>
          <asp:ListItem>Twelth Standard</asp:ListItem>
      </asp:DropDownList>
  </div>
  ...
  <div class="col-12">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
        ErrorMessage="Email is a required field." ControlToValidate="TextBox4" 
        ForeColor="Red"></asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
        ErrorMessage="Please enter the valid mail ID" ForeColor="Red" 
  ...
  <div class="col-md-6">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
        ErrorMessage="Age is a required field." ControlToValidate="TextBox5" 
        ForeColor="Red"></asp:RequiredFieldValidator><br />
    <asp:RangeValidator ID="RangeValidator1" runat="server" 
        ErrorMessage="Age is out of range." ControlToValidate="TextBox5" 
